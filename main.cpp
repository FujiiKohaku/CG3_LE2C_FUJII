...
#pragma endregion
    ...
    // Shaderをコンパイルする
    IDxcBlob* vertexShaderBlob = CompileShader(L"Object3d.VS.hlsl", L"vs_6_0", dxcUtils, dxcCompiler,
    ...
    // 通常モデル用リソース
    //--------------------------
    ID3D12Resource* vertexResource = CreateBufferResource(device, sizeof(VertexData) * kNumVertices);
    ...
    // 頂点リソースの作成とマップ
    ID3D12Resource* vertexResourceSphere = CreateBufferResource(device, sizeof(VertexData) * kNumVertices);
